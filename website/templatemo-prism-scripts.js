...
// Portfolio data for carousel
        ...
        const portfolioData = [
            {
                ...
                description: 'Indulgent Chocolate fudge ice cream loaded with fudge dark chocolate swirls. The ultimate chocolate lover’s delight.',
                image: 'images/6.png',
        ...
        function createCarouselItem(data, index) {
            ...
            item.innerHTML = `
                <div class="carousel-image-wrapper">
                    <img src="${data.image}" alt="Product ${data.id}" class="carousel-image">
                </div>
            `;
        ...
        // Enable pointer drag (click-and-slide) for carousel
        (function enableCarouselDrag(){
            ...
            // Prevent horizontal touch scroll interfering with drag
            ...
            carouselEl.addEventListener('pointerdown', (e) => {
                ...
                // disable transition to follow cursor precisely
            ...
            window.addEventListener('pointermove', (e) => {
                ...
                // visually follow cursor while dragging
                carouselEl.style.transform = `translateX(${dx}px)`;
            });

            function finishDrag(e) {
                if (!isDown) return;
                isDown = false;
                try { if (activePointerId != null) carouselEl.releasePointerCapture(activePointerId); } catch (_) {}
                ...
                carouselEl.style.transition = 'transform 0.5s cubic-bezier(0.4, 0.0, 0.2, 1)';
        ...
        // Loading screen - ensure loader is removed so content becomes visible
